(() => {
  ...
  var InlineSortable = class {
    constructor(inlineFieldSet) {
      ...
      inlineFieldSet.querySelectorAll(".inline-related .sort i.move-begin").forEach((elem) => elem.addEventListener("click", (event) => this.move(event.target, "begin")));
      inlineFieldSet.querySelectorAll(".inline-related .sort i.move-end").forEach((elem) => elem.addEventListener("click", (event) => this.move(event.target, "end")));
    }
    onEnd() {
